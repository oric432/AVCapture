...
build_bundle_folder(const std::filesystem::path& bundles_root, const std::filesystem::path& src_log, bool save_localy, VsType vs_type, RoleType role_type, std::string_view id = "", std::string_view ip = "");
