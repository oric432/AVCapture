...
public:
    ...
    Error::VoidResult encode_frame(uint8_t* src_data, int src_line_size, int64_t pts, EncodedVideoFrame& encoded_frame);
...
private:
    ...
    Error::VoidResult try_open_encoder(const char* encoder_name, const Core::VideoConfig& config);
